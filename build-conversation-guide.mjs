...
const busanPoints = [
  { n: 1, time: "07:30-08:15", name: "釜山港国际客运码头", mapName: "부산항국제여객터미널", lat: 35.1174375, lng: 129.0486875, note: "下船、入境；08:15 前完成集合并出发。" },
  { n: 2, time: "08:45-09:00", name: "松岛海水浴场", mapName: "송도해수욕장", lat: 35.0758, lng: 129.0167, note: "海边快速拍照，09:00 前前往缆车站。" },
  { n: 3, time: "09:00-10:20", name: "松岛海上缆车", mapName: "송도해상케이블카", lat: 35.0763876, lng: 129.0236199, note: "水晶车厢往返，票价约 24,000 韩元。" },
  { n: 4, time: "10:40-11:40", name: "甘川文化村", mapName: "감천문화마을", lat: 35.0975, lng: 129.0107, note: "集中游览核心区域，11:40 准时离开。" },
  { n: 5, time: "12:20-13:20", name: "田浦洞肉合家烤肉", mapName: "육합가 전포점", lat: 35.1577, lng: 129.0632, note: "午餐 1 小时，热门时段到店先取号。" },
  { n: 6, time: "13:20-14:00", name: "田浦咖啡街", mapName: "전포카페거리", lat: 35.1588, lng: 129.0648, note: "咖啡、小店和街区散步，14:00 准时打车。" },
  { n: 7, time: "14:30-15:50", name: "新世界百货 Centum City", mapName: "신세계백화점 센텀시티점", lat: 35.1692, lng: 129.1292, note: "购物 80 分钟；15:50 必须离开商场。" },
  { n: 8, time: "16:40-17:00", name: "返回釜山港", mapName: "부산항국제여객터미널", lat: 35.1174375, lng: 129.0486875, note: "目标 17:00 前抵达港口，邮轮 18:00 离港。" },
];
    ...
    <main>
      ...
      <section class="day" id="busan">
        <div class="day-cover busan-cover">
          ...
          <h2>釜山经典一日游</h2>
          <p>松岛海边与缆车、甘川文化村、田浦洞午餐、新世界购物，17:00 前回到港口。</p>
          <div class="route-line"><span>邮轮码头</span><span>松岛海水浴场</span><span>松岛海上缆车</span><span>甘川文化村</span><span>田浦洞烤肉</span><span>田浦咖啡街</span><span>新世界 Centum City</span><span>回船</span></div>
        </div>
        <div class="day-body">
          <h2>景点详情</h2>
          <div class="place-grid">
            ${placeCard("松岛海上缆车", images.songdo, "4.4/5", "先在海水浴场拍照，再乘水晶车厢往返看海。", "08:45-10:20", "송도해상케이블카", busanPoints[2])}
            ${placeCard("甘川文化村", images.gamcheon, "4.4/5", "集中游览核心拍照区域，控制在 1 小时内。", "10:40-11:40", "감천문화마을", busanPoints[3])}
            ${placeCard("田浦洞街区", images.jeonpo, "4.3/5", "肉合家午餐后逛田浦咖啡街，14:00 准时离开。", "12:20-14:00", "전포카페거리", busanPoints[5])}
            ${placeCard("釜山港国际客运码头", images.busanPort, "靠岸点", "邮轮 18:00 离港，当前计划 16:40-17:00 抵港；若船方 All aboard 更早，以船方通知为准。", "2026.6.22 07:00-18:00", "부산항국제여객터미널", busanPoints[0])}
          </div>

          <h2 style="margin-top:26px;">早中晚时间线</h2>
          <div class="timeline">
            ${slot("早", "07:30-08:15", "下船、入境", "完成入境和集合，08:15 准时离开码头。")}
            ${slot("早", "08:15-08:45", "打车去松岛", "目的地输入 송도해수욕장。")}
            ${slot("早", "08:45-09:00", "松岛海水浴场拍照", "只安排 15 分钟，随后步行前往缆车站。")}
            ${slot("早", "09:00-10:20", "松岛海上缆车往返", "乘水晶车厢往返，10:20 结束。")}
            ${slot("早", "10:20-10:40", "打车去甘川文化村", "目的地输入 감천문화마을。")}
            ${slot("中", "10:40-11:40", "甘川核心区域拍照", "控制在核心路线，11:40 准时离开。")}
            ${slot("中", "11:40-12:20", "打车去田浦洞", "目的地输入 육합가 전포점。")}
            ${slot("中", "12:20-13:20", "肉合家午餐", "用餐时间 1 小时。")}
            ${slot("午后", "13:20-14:00", "田浦咖啡街", "逛街或咖啡，14:00 准时打车。")}
            ${slot("午后", "14:00-14:30", "打车去新世界", "目的地输入 신세계백화점 센텀시티점。")}
            ${slot("午后", "14:30-15:50", "新世界 Centum City 购物", "15:30 查看 NAVER/Kakao 回港 ETA；若超过 50 分钟立即离开，15:50 是绝对最晚时间。")}
            ${slot("回船", "15:50-17:00", "离开商场 → 返回港口", "15:50 必须上车，预计 16:40-17:00 抵达；若船方 All aboard 更早，以船方通知为准。")}
          </div>
